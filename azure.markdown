...
<head>
    ...
    <META NAME="Title" CONTENT="A Public Cloud Comparison | Azure">
    <META NAME="Keywords" CONTENT="Azure, AWS vs Azure, Azure vs Google">
    ...
    <META NAME="Subject" CONTENT="A Public Cloud Comparison | Azure">
    <meta property="og:type" content="website">
    <meta property="og:title" content="A Public Cloud Comparison | Azure">
    ...
    <meta property="og:site_name" content="A Public Cloud Comparison | Azure">
    ...
    <meta name="twitter:title" content="A public Cloud Compareison : Azure">
    <title>Azure | A detailed comparison and mapping between various cloud services</title>
</head>
